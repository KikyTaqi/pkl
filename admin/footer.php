<footer class="bg-dark text-light py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <h5>About Us</h5>
                <p>Program PKL Bagian 1 yang dibuat oleh Rifqi Ramandhani Taqiyudin. Meliputi Pembuatan Surat Pengajuan dan Pengantar.</p>
            </div>
            <div class="col-lg-4 offset-lg-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a target="_blank" style="text-decoration: none;" href="https://github.com/KikyTaqi/pkl" class="link-primary"><i class="bi bi-github"></i> v0.05</a></li>
        ...
        <div class="text-center">
            <p>&copy; 2024 TaQi. All rights reserved.</p>
        </div>
    </div>
</footer>
